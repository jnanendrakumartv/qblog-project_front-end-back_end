...
class ReactJs extends Component{
    constructor(props) {
        super(props);
        this.state = { name:"", array:[],   count:1, Users: [], RUsers:[], comments:'', cError:'' };
    }
    incrementMe =async () => {
        debugger;
    ...
    handleSubmit = async () => {
       ...
       componentDidMount(){
        ...
        .then(res => {
        this.setState({RUsers: res.data});
        console.log(this.state.RUsers);
        });
        ...
        return(
            ...
            <div className="quotes">     
                ...
                <div id="net" className="row">                      
                    ...
                    <div className="col-xs-4 col-sm-4 col-md-4 col-lg-4"> <img className="cbook1" src={rc1} alt={"rc1"} height="200" width="200" ></img>
                    { this.state.Users.map(category => {
                          if(category.authorname==='Artemij')
                             return (
                                 <div>
                      ...
                      {this.state.RUsers.map(category => {
                      if(category.count)
                        like=like+1;
                             })}
